...
public class CommonUtils {
	...
	// diskWritesAndReadsOnInit.put(fs.getDevName(), usage.getDiskReadBytes() + "|" +
	...
	// System.setProperty("java.library.path", classpath + File.separator + "sigar" +
	...
	// status.setServerOs(props.getProperty("os.name") + " " + props.getProperty("os.saltedfish") + " " +
