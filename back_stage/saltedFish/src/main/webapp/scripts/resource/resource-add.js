...
var mainMenuParentId=1010; //主菜单的父Id为1010;
...
$(function(){
	...
	//根据单选框选中的值做不同的校验
  	jQuery.validator.addMethod("checkMainMenu", function(value, element) {   
	...
	jQuery.validator.addMethod("checkChildMenu", function(value, element) { 
  		var type =$("input[name='type']:checked").val();
